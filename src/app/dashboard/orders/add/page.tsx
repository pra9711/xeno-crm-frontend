...
export default function AddOrderPage() {
  ...
  useEffect(() => {
    const fetchCustomers = async () => {
      try {
        const response = await apiClient.request<unknown>({ method: 'get', url: '/customers' })
    ...
    <div className="bg-background text-foreground min-h-screen px-4 lg:px-8 py-6">
      <div className="max-w-4xl mx-auto px-4 lg:px-6 py-6">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">Add a new order for your customer</p>
              </div>
            </div>
            <div className="flex items-center gap-2">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          {/* Customer Selection */}
          <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border border-white/20 p-6 overflow-visible">
            ...
            <div className="relative">
              ...
              <div className="relative">
                ...
                {showCustomerDropdown && customerSearch && (
                  <div className="absolute z-50 w-full mt-1 bg-white border border-gray-200 rounded-lg shadow-lg max-h-60 overflow-y-auto left-0">
          ...
          <div className="flex items-center justify-end gap-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors duration-200 font-medium disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
            >
              {loading ? (
                <>
